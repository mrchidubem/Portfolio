...
// ── Animation variants (exact same as final Homepage) ───────────────────────
const fadeInUp = {
...
export default function ContactPage() {
    ...
    try {
      const response = await emailjs.send(
        ...
        'template_k5huwmg',
        {
          ...
          content: formData.message // Reuse 'content' variable in template for message
        },
        'J4cq0UVZeRP4Hlm4O'
      );
  ...
  // ── Same ultra-smooth Lenis as Homepage
  useEffect(() => {
  ...
  return (
    <div className="relative bg-gray-950 text-gray-100 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-32 md:py-40">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-black bg-gradient-to-r from-gray-400 via-gray-300 to-gray-500 bg-clip-text text-transparent tracking-tighter mb-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
          ...
          <motion.div
            ...
            viewport={{ once: false }}
            transition={{ duration: 0.9, ease: [0.25, 0.46, 0.45, 0.94] }}
            className="bg-gray-900/70 backdrop-blur-xl border border-gray-800/60 rounded-3xl p-8 md:p-10"
          >
            <h2 className="text-3xl font-bold mb-8 bg-gradient-to-r from-gray-400 to-gray-500 bg-clip-text text-transparent">Get in Touch</h2>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gray-950/50 border border-gray-700 rounded-xl px-5 py-4 text-white placeholder-gray-500 focus:outline-none focus:border-gray-500 focus:ring-1 focus:ring-gray-500/40 transition-all"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={6}
                  className="w-full bg-gray-950/50 border border-gray-700 rounded-xl px-5 py-4 text-white placeholder-gray-500 focus:outline-none focus:border-gray-500 focus:ring-1 focus:ring-gray-500/40 transition-all resize-none"
              ...
              <motion.button
                ...
                type="submit"
                disabled={loading}
                className={`w-full bg-gradient-to-r from-gray-700 to-gray-800 py-5 rounded-xl text-xl font-bold shadow-xl shadow-gray-900/30 hover:shadow-gray-700/50 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed`}
              >
          ...
          >
            <div className="bg-gray-900/70 backdrop-blur-xl border border-gray-800/60 rounded-3xl p-8 md:p-10">
              <h3 className="text-2xl font-bold mb-6 bg-gradient-to-r from-gray-400 to-gray-500 bg-clip-text text-transparent">Preferred Channels</h3>
              <ul className="space-y-6">
                {[
                  ...
                  >
                    ...
                    <a
                      href={item.link}
                      className="block text-xl font-medium text-gray-300 hover:text-gray-200 transition-colors mt-1"
            ...
            <div className="bg-gradient-to-br from-gray-900/90 to-gray-950/40 border border-gray-800/60 rounded-3xl p-8 text-center">
              <h3 className="text-2xl font-bold mb-4 text-white">Response Time</h3>
              <p className="text-3xl font-black text-gray-300">Usually within 24h</p>
              <p className="text-gray-400 mt-2">Strategic proposals prioritized</p>
            </div>
          </motion.div>
        </div>
      </div>
